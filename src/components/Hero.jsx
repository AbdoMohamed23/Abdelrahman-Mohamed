        ...
        <div id='hero' className='grid grid-cols-1 sm:grid-cols-3 gap-8 max-w-[1200px] md:h-[70vh] mx-auto py-8 bg-black'>
            <div className='col-span-1 sm:col-span-2 px-5'>
                ...
                <h1 className='text-white text-4xl sm:text-5xl lg:text-7xl font-extrabold'>
                    <span className='pb-6 primary-color'>
                        {t("hero_title")}
                    </span> <br />
                ...
                <div className='mt-2'>
                    <a href="../../public/Abdelrahman Mohamed Front-End Developer.pdf" className='px-6 py-3 w-full rounded-xl me-4 bg-gradient-to-br bg-primary-color text-white'>{t("download_cv")}</a>
